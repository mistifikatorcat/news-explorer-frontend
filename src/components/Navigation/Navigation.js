    ...
    <nav className="navbar">
      <div className="navbar__links">
        <NavLink
          ...
          className={
            `${
              isHome ? "navbar__link_current" : ""
            } navbar__link navbar__link` + darkButton
          } //if not work try ? :
        >
          Home
        </NavLink>
        ...
        {isLoggedIn ? (
          <>
            ...
            <button
              className={`${
                isHome
                  ? "navbar__button navbar__logout"
                  : "navbar__button navbar__logout navbar__button_color_black navbar__logout_color_black"
              }`}
              onClick={onLogout}
            >
              {username}
          ...
          <>
            <button
              ...
              className={`navbar__button navbar__login ${
                isHome
                  ? ""
                  : "navbar__button_color_black navbar__login_color_black"
              }`}
